...
class Text {
  ...
  get(stringify = true) {
    ...
    if (this.command != null)
      obj.clickEvent = { action: "run_command", value: `${this.command}` };
    if (this.hover != null)
      obj.hoverEvent = { action: "show_text", contents: this.hover };
    if (this.url != null)
      obj.clickEvent = { action: "open_url", value: `${this.url}` };
    if (this.suggest != null)
      obj.clickEvent = { action: "suggest_command", value: `${this.suggest}` };
    if (this.copy != null)
      obj.clickEvent = { action: "copy_to_clipboard", value: `${this.copy}` };
